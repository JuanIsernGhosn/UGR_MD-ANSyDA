...
En vez de usar la distancia euclídea y de Mahalanobis, podemos utilizar la relativa para medir la separación entre una observación y el centroide al que está asignado. Así, definimos la función *top_clustering_outliers_distancia_relativa* para llevar a cabo su cálculo y  hallar aquellos *numero.de.outliers* elementos de con la mayor.
